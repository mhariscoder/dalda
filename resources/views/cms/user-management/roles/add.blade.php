...
@section('content')
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            ...
            <form action="/admin/add-role" method="POST" class="needs-validation" novalidate>
                @csrf
                @if ($errors->any())
                ...
                <div class="form-row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="role_name" name="role_name" placeholder="Role Name"
                            value="{{ old('role_name') }}" maxlength="55" required>
                        ...
                        <div class="form-row ml-3">
                            <label class="switch" style="margin-top: -17px !important">
                                <input type="checkbox" class="permission is_active" id="permissions{{ $key }}"
                                    ...
                                    {{ (int) old("permissions.$key") === $val->id ? 'checked' : '' }}>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" class="form-control rounded" id="name"
                                                           ...
                                                           value="{{ old('role_name') }}" maxlength="55">
                                                </div>
                                            </div>
