                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="first_name" name="first_name" placeholder="First Name"
                            value="{{ old('first_name') }}" maxlength="55" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        value="{{ old('last_name') }}" maxlength="55" required>
                        <div class="invalid-feedback">
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="cnic" name="cnic" placeholder="CNIC"
                            value="{{ old('cnic') }}" minlength="13" maxlength="13">
                            <div class="invalid-feedback">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control rounded" id="first_name"
                                                        ...
                                                        value="{{ old('first_name') }}" maxlength="55">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="last_name">Last Name <span
                                                            class="required-class">*</span></label>
                                                    <input type="text" class="form-control rounded" id="last_name"
                                                        ...
                                                        value="{{ old('last_name') }}" maxlength="55">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
