    ...
    <div class="page-title-wrapper">
        ...
        <div class="page-title-actions">
            <div class="d-inline-block ">
                <a href="/admin/add-upload-document"  class="btn-shadow btn btn-primary">
    ...
    <div class="col-lg-12">
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                @endif
                <h5 class="card-title">Uploaded Documents List</h5>
                ...
                <table class="mb-0 table table-striped table-bordered the-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $key + 1 }}</td>
                            <td>{{ $upload->title }}</td>
                            <td>{{ \Illuminate\Support\Str::words($upload->description,40) ?? '' }}</td>
                            @if(!empty($upload->name))
                                <td>
                                    <a href="{{Storage::url('uploads/documents/'.$upload->name ?? '')}}" data-toggle="tooltip" data-placement="bottom"
                            ...
                            <td class="d-flex justify-content-left align-items-center">
                                <a href="/admin/update-upload-document/{{$upload->id}}" class="text-warning" data-toggle="tooltip" data-placement="bottom"
                                    ...
                                    @if(count($uploads) > 0)
                                        @foreach($uploads as $key => $upload)
                                            <tr>
                                                ...
                                                @endif
                                                <td>
                                                    <a href="/admin/update-upload-document/{{$upload->id}}"
    ...
    <script>
        ...
        function deleteDocument(input, documentId) {
            swal({
                ...
                if (willDismiss) {
                    axios.get(`/admin/delete-document/${documentId}`).then((response) => {
                        swal({
