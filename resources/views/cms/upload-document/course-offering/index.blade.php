    ...
    <div class="page-title-wrapper">
        ...
        <div class="page-title-actions">
            <div class="d-inline-block ">
                <a href="/admin/add-course-offering"  class="btn-shadow btn btn-primary">
                ...
                <table class="mb-0 table table-striped table-bordered the-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $key + 1 }}</td>
                            <td>{{ $course->title }}</td>
                            <td>{{ \Illuminate\Support\Str::words($course->description,40) ?? '' }}</td>
                            <td class="d-flex justify-content-left align-items-center">
                                <a href="/admin/update-course-offering/{{$course->id}}" class="text-warning" data-toggle="tooltip" data-placement="bottom"
                                ...
                                <a href="javascript:void(0)" class="text-danger" data-toggle="tooltip" data-placement="bottom"
                                    title="" data-original-title="Delete" onclick="deleteDocument(this, '{{$course->id}}')"> <i class="fas fa-trash-alt  ml-2 "></i> </a>
                            </td>
                        </tr>
                        @endforeach
                    @endif
                    ...
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="/admin/add-course-offering" class="btn btn-primary float-right">Add +</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        @foreach($courses as $key => $course)
                                            <tr>
                                                ...
                                                <td class="d-flex justify-content-start">
                                                    <a href="/admin/update-course-offering/{{$course->id}}"
                                                       class="btn btn-info btn-sm">Update</a>
                                                    <a href="javascript:void(0);"
                                                       class="btn btn-danger btn-sm ml-1"
                                                       onclick="deleteDocument(this, '{{$course->id}}')">Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
