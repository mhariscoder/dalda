...
<div class="main-card mb-3 card">
    <div class="card-body">
        <h5 class="card-title">Update Exam</h5>
        <form id="applyForm" class="needs-validation" novalidate>
            ...
            <div class="form-row">
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control" id="title" name="title" placeholder="Title"
                        value="{{ old('title',$exam->title) }}" maxlength="55" required>
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <textarea name="description" id="description" class="form-control" rows="3" required>{{ old('description',$exam->description) }}</textarea>
                    <div class="invalid-feedback">
                    ...
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="/admin/exam" class="btn btn-primary float-right">← Back</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" name="title" id="title" class="form-control"
                                                           value="{{ old('title',$exam->title) }}" maxlength="50">
                                                </div>
                                            </div>
