...
<div class="main-card mb-3 card">
    <div class="card-body">
        <h5 class="card-title">Update Test Schedule</h5>
            ...
            <div class="form-row">
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control" id="title" name="title" placeholder="Title"
                        value="{{ old('title', $test->title) }}" maxlength="55" required>
                ...
                <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="card-title">Update Test Schedule</h4>
                                </div>
                                <div class="col-md-6">
                                    <a href="/admin/test-schedule" class="btn btn-primary float-right">← Back</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
...
@push('scripts')
    ...
    <script>
        function submitFormData() {
            ...
            axios({
                method: 'post',
                url: '/admin/update-test-schedule/' + '{{$test->id}}',
                data: bodyFormData,
                ...
                .then(function (response) {
                    if (response) {
                        ...
                        swal({
                            ...
                            if (successBtn) {
                                window.location.href = "/admin/test-schedule";
                            }
                        }).catch(error => {
                            swal({
