...
<div class="main-card mb-3 card">
    <div class="card-body">
        ...
        <form id="applyForm" action="/admin/add-eligibility-criteria" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
            @csrf
            @if ($errors->any())
                ...
                <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="card-title">Add Eligibility Criteria</h4>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="card-body">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <form action="/admin/add-eligibility-criteria" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @if($errors->any())
                                                <div class="alert alert-danger">
                                                    <stron>Whoops!</stron>
