                    ...
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="/admin/pages/faq/add" class="btn btn-primary float-right">Add
                                        +</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped the-table">
                                    ...
                                    <tr>
                                        ...
                                        <th style="max-width: 125px;">Title</th>
                                    ...
                                    @if (count($resultSet) > 0)
                                        @foreach ($resultSet as $key => $val)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/admin/pages/faq/{{$val->id}}/update"
    ...
    <script>
        ...
        function deleteRecord(input, cmsMediaCenterId) {
            swal({
                ...
                if (willDelete) {
                    axios.get(`/admin/pages/faq/${cmsMediaCenterId}/delete`).then(function (response) {
