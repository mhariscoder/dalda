    ...
    <div class="page-title-wrapper">
        ...
        <div class="page-title-actions">
            <div class="d-inline-block ">
                <a href="/admin/pages/university-icons/create"  class="btn-shadow btn btn-primary">
    ...
    <div class="col-lg-12">
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                @endif
                <h5 class="card-title">University Icons LIST</h5>
                <div class="table-responsive">
                <table class="mb-0 table table-striped table-bordered the-table">
                    <thead>
                        <tr>
                            <th style="max-width: 20px;">ID#</th>
                            <th style="width:400px;">Icons</th>
                            <th>Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $key + 1 }}</td>
                            <td style="justify-content: center"><img src="{{ asset('assets/website/images/pages/university-icons/' . $val->icon) }}" class="img-fluid rounded" height="200px" width="200px"></td>
                            <td class="d-flex justify-content-left align-items-center">
                                <a href="/admin/pages/university-icons/{{$val->id}}/edit" class="text-warning" data-toggle="tooltip" data-placement="bottom"
                    ...
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="/admin/pages/add-about" class="btn btn-primary float-right">Add
                                        +</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped the-table">
                                    ...
                                    <tr>
                                        ...
                                        <th style="max-width: 300px;">Short Description</th>
                                        <th>Actions</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @if (count($resultSet) > 0)
                                        @foreach ($resultSet as $key => $about)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td>{{ \Illuminate\Support\Str::words($about->short_description, 50) }}
                                                </td>
                                                <td>
                                                    <a href="/admin/pages/update-about/{{$about->id}}"
                                                       class="btn btn-success btn-primary">Update</a>
                                                    <a href="javascript:void(0)"
                                                       class="btn btn-danger a-btn-custom"
                                                       onclick="deleteRecord(this, '{{ $about->id }}')">Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
    ...
    <script>
        ...
        function deleteRecord(input, cmsAboutId) {
            swal({
                ...
                if (willDelete) {
                    axios.post(`/admin/pages/university-icons/${cmsAboutId}`, {_method: 'DELETE'}).then(function (response) {
