    ...
    <div class="page-title-wrapper">
        ...
        <div class="page-title-actions">
            <div class="d-inline-block ">
                <a href="/admin/pages/story/create"  class="btn-shadow btn btn-primary">
                ...
                <table class="mb-0 table table-striped table-bordered the-table">
                    <thead>
                        <tr>
                            ...
                            <th style="width:400px;">Video Link</th>
                            <th>Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{$val->getVideos->first()->path.'/'.$val->getVideos->first()->video_name ?? ''}}"
                                    target="_blank" class="btn btn-dark btn-sm">Video Link</a>
                            </td>
                            <td class="d-flex justify-content-left align-items-center">
                                <a href="/admin/pages/story/{{$val->id}}/edit" class="text-warning" data-toggle="tooltip" data-placement="bottom"
    ...
    <script>
        ...
        function deleteRecord(input, cmsAboutId) {
            swal({
                ...
                if (willDelete) {
                    axios.post(`/admin/pages/story/${cmsAboutId}`, {_method: 'DELETE'}).then(function (response) {
