        ...
        <form id="applyForm">
            ...
            <div class="form-row">
                <div class=" form-group col-md-12 mb-3">
                    ...
                    <input class="form-control" type="text" id="heading" name="heading" value="{{ $resultSet->heading }}" placeholder="Enter Heading">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-12">
                    <label for="video_description">Video Description </label>
                    <textarea name="video_description" id="video_description" class="form-control editor" rows="3">{{ $resultSet->video_description }}</textarea>
                </div>
            </div>
            <div class="form-row">
                <div class=" form-group col-md-12 mb-3">
                    <label for="student_name">Student Name <span class="required-class">*</span></label>
                    <input class="form-control" type="text" id="student_name" value="{{ $resultSet->student_name }}" name="student_name" placeholder="Enter Student Name">
                </div>
            </div>
            <div class="form-row">
                <div class=" form-group col-md-12 mb-3">
                    <label for="uni_name">University Name <span class="required-class">*</span></label>
                    <input class="form-control" type="text" id="uni_name" value="{{ $resultSet->uni_name }}" name="uni_name" placeholder="Enter University Name">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-12">
                    <label for="description">Description </label>
                    <textarea name="description" id="description" class="form-control editor" rows="3">{{ $resultSet->description }}</textarea>
                </div>
            </div>
            <div class="form-row upload">
                <div class="form-group col-md-12">
                    ...
                    @if (!empty($resultSet->getVideos->first()->path))
                        <a href="{{$resultSet->getVideos->first()->path.'/'.$resultSet->getVideos->first()->video_name ?? ''}}" target="_blank" class="btn btn-dark btn-sm mt-2">Video Link</a>
                    @endif
                </div>
            </div>
...
@push('scripts')
    ...
    <script>
        ...
        function submitFormData(button) {
            ...
            axiosInstance.post('/admin/pages/story/'+'{{$resultSet->id}}', bodyFormData,{
