...
@section('content')
    ...
    <div class="main-card mb-3 card">
        ...
        <div class="card-body">
            <div class="row w-100 ">
                <div class="col-md-6">
                    <h4 class="card-title">Update Hospital Details</h4>
                </div>
                {{-- <div class="col-md-6">
            ...
            <form id="hospitalForm">
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" name="name" id="name" class="form-control"
                            value="{{ old('name', $updateHospital->name) }}">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="number" name="sort_order" id="sort_order" class="form-control"
                            value="{{ old('sort_order', $updateHospital->sort_order) }}">
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-12 mb-3">
                        ...
                        <div class="input-group">
                            @if ($updateHospital->image)
                                <a href="{{ asset('assets/website/images/pages/health/' . $updateHospital->image) }}"
                                    data-toggle="lightupdateHospital" data-gallery="gallery" class="col-md-4">
                                    <img src="{{ asset('assets/website/images/pages/health/' . $updateHospital->image) }}"
                ...
                <button type="submit" class="btn btn-primary float-right" onclick="submitFormData()">Save </button>
            </form>
...
@push('scripts')
    ...
    <script>
        function submitFormData(e) {
            ...
            axios.post('/admin/pages/health/hospitals-update/{{ $updateHospital->id }}', bodyFormData, {
                    headers: {
                    ...
                    if (response) {
                        ...
                        closeOnClickOutside: false,
                            ...
                            if (successBtn) {
                                window.location.href="/admin/pages/health/hospitals-update" + "{{ $updateHospital->id }}"
