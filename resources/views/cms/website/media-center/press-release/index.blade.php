                ...
                <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="card-title">Press Release Page</h4>
                                </div>
                                <div class="col-md-6">
                                    <a href="/admin/pages/press-releases/add" class="btn btn-primary float-right">Add
                                        +</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    @if (count($resultSet) > 0)
                                        @foreach ($resultSet as $key => $val)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/admin/pages/press-releases/{{$val->id}}/update"
    ...
    <script>
        ...
        function deleteRecord(input, cmsMediaCenterId) {
            swal({
                ...
                if (willDelete) {
                    axios.get(`/admin/pages/press-releases/${cmsMediaCenterId}/delete`).then(function (response) {
