                ...
                <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="card-title">Update Press Release Page</h4>
                                </div>
                                <div class="col-md-6">
                                    <a href="/admin/pages/press-releases" class="btn btn-primary float-right">← Back</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
...
@push('scripts')
    ...
    <script>
        function submitFormData() {
            ...
            axios.post('/admin/pages/press-releases/'+'{{$updateMediaCenter->id}}/update', bodyFormData,{
                ...
                if (response) {
                    ...
                    swal({
                        ...
                        if (successBtn) {
                            window.location.href = "/admin/pages/press-releases";
                        }
                    }).catch(error => {
                        swal({
