                ...
                <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="card-title">Update Volunteer Page</h4>
                                </div>
                                <div class="col-md-6">
                                    <a href="/admin/media-center/volunteers" class="btn btn-primary float-right">← Back</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <form id="applyForm">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control rounded allowAlphabetOnly" name="student_name" value="{{$updateMediaCenter->student_name}}">
                                            </div>
                                        </div>
...
@push('scripts')
    ...
    <script>
        function submitFormData() {
            ...
            axios.post('/admin/media-center/volunteers/'+'{{$updateMediaCenter->id}}/update', bodyFormData,{
                ...
                if (response) {
                    ...
                    swal({
                        ...
                        if (successBtn) {
                            window.location.href = "/admin/media-center/volunteers";
                        }
                    }).catch(error => {
                        swal({
