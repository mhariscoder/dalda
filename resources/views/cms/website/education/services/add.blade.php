    ...
    <main>
        ...
        <div class="main-card mb-3 card">
            ...
            <div class="card-body">
                <div class="row w-100 ">
                    <div class="col-md-6">
                        <h4 class="card-title">Add Services Details</h4>
                    </div>
                </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" name="heading" id="heading" class="form-control"
                                value="{{ old('heading') }}" maxlength="55">
                        </div>
                    </div>
...
@push('scripts')
    ...
    <script>
        function submitFormData() {
            ...
            let form = document.querySelector('#servicesForm');
            ...
            axios({
                    method: 'post',
                    url: '/admin/pages/education/add-services-list/' + {{ \App\Models\CMSEducation::EDUCATION_ID }} +
                        '/add',
                    data: bodyFormData,
                    headers: {
                        ...
                        swal({
                            ...
                            if (successBtn) {
                                window.location.href =
                                    '/admin/pages/education/services-list/{{ \App\Models\CMSEducation::EDUCATION_ID }}';
                            }
                        }).catch(error => {
                            swal({
