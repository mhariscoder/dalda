                    ...
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="/admin/blog/categories/add" class="btn btn-primary float-right">Add +</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    @if(count($categories) > 0)
                                        @foreach($categories as $key => $category)
                                            <tr>
                                                ...
                                                <td>{{ $category->name }}</td>
                                                <td>
                                                    <a href="/admin/blog/categories/{{$category->id}}/update"
                                                       class="btn btn-success btn-primary">Update</a>
                                                    <a href="javascript:void(0)"
                                                       class="btn btn-danger a-btn-custom"
                                                       onclick="deleteRecord(this, '{{ $category->id }}')">Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
...
@push('scripts')
    ...
    <script>
        ...
        function deleteRecord(input, categoryId) {
            swal({
                title: "Are you sure?",
                icon: "warning",
                buttons: true,
                ...
                if (willDelete) {
                    axios.get(`/admin/blog/categories/${categoryId}/delete`).then(function (response) {
