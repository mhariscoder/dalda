                                    ...
                                    <form id="applyForm">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" name="title" id="title" class="form-control"
                                                       value="{{ old('title',$updatePost->title) }}">
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <select class="form-control rounded" name="category" id="category">
                                                    @foreach($categories as $category)
                                                        <option value="{{$category->id}}" {{ (int)old('category',$updatePost->post_category_id) ===  $category->id ? "selected" : "" }}>{{$category->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="description" id="description" class="form-control"
                                                          rows="6">{{ old('description',$updatePost->description) }}</textarea>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    <div class="input-group">
                                                        <img src="{{ asset('assets/website/blog/images/'.$updatePost->image) }}"
                                                             height="70" width="70">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <select class="form-control tag_id" id="tags"
                                                        name="tags[]"
                                                        multiple="multiple">
                                                    @foreach($tags as $tag)
...
@push('scripts')
    ...
    <script>
        ...
        function submitFormData() {
            ...
            axios.post('/admin/blog/posts/{{$updatePost->id}}/update', bodyFormData,{
