    ...
    <div class="page-title-wrapper">
        ...
        <div class="page-title-actions">
            <div class="d-inline-block ">
                <a href="/admin/high-potential-student/create"  class="btn-shadow btn btn-primary">
    ...
    <div class="col-lg-12">
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                @endif
                <h5 class="card-title">High Potential Student LIST</h5>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-left align-items-center">
                                <a href="/admin/high-potential-student/{{$val->id}}/edit" class="text-warning" data-toggle="tooltip" data-placement="bottom"
    ...
    <script>
        ...
        function deleteRecord(input, cmsAboutId) {
            swal({
                ...
                if (willDelete) {
                    axios.post(`/admin/high-potential-student/${cmsAboutId}`, {_method: 'DELETE'}).then(function (response) {
