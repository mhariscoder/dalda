...
<div class="main-card mb-3 card">
    <div class="card-body">
        ...
        <form action="/admin/test-dates/add" method="POST" class="needs-validation" novalidate>
            @csrf
            @if($errors->any())
                ...
                <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="card-title">Add Test Dates</h4>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="card-body">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <form action="/admin/test-dates/add" method="POST">
                                            @csrf
                                            @if($errors->any())
                                                <div class="alert alert-danger">
                                                    <strong>Whoops!</strong>
