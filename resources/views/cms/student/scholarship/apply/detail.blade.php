            ...
            <div class="page-title-actions">
                <div class="d-inline-block dropdown">
                    <a id="tableToExcel" class="btn-shadow btn btn-success ml-2"
                        href="/admin/apply-for-scoloarships/pdf/{{ $apply->id }}"
                        title="" >
            ...
            <div class="row">
                <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <div class="row">
                                ...
                                <div class="col-md-6 row justify-content-end">
                                    <a href="/admin/apply-for-scoloarships/pdf/{{ $apply->id }}" class="btn btn-success mr-2">Download Pdf</a>
                        ...
                        <div class="card-body">
                            <div class="card-body" id="detailDoc">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control rounded"
                                                       ...
                                                       value="{{ $apply->group }}" maxlength="100" readonly>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Marks in Matric ( Write in this format:
                                                    600/1050 ) </label>
                                                <input type="text" class="form-control rounded"
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="password">What is source of income of your
                                                    father/guardian?<span class="readonly-class">*</span></label>
...
@push('scripts')
    ...
    <script>
        var doc = new jsPDF();
        var elementHTML = $('#detailDoc').html();
