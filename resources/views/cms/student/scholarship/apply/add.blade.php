            ...
            <form action="/admin/add-apply-for-scoloarship" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control rounded allowNumberOnly" id="teach_cell_no1"
                            name="teach_cell_no1" placeholder="Enter Cell No" minlength="11" maxlength="13" value="{{ old('teach_cell_no1') }}"
                            required>
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group col-md-4">
                        <label for="password">Cell No<span class="required-class">*</span></label>
                        <input type="text" class="form-control rounded allowNumberOnly" minlength="11" maxlength="13" id="teach_cell_no2"
                            name="teach_cell_no2" placeholder="Enter Cell No" value="{{ old('teach_cell_no2') }}"
                            required>
                        <div class="invalid-feedback">
                            Please enter a cell no.
                        </div>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".college_email").keyup(function(e) {
        ...
        function submitFormData() {
            ...
            axios({
                    method: 'post',
                    url: '/admin/add-apply-for-scoloarship',
                    data: bodyFormData,
                    headers: {
