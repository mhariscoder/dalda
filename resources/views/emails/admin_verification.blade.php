    ...
    <tr>
        <td align="center">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td align="center" bgcolor="#414a51">
                                    ...
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table-inner">
                                        ...
                                        <tr>
                                            <td align="center" style="line-height: 0px;">
                                                <img style="display:block; line-height:0px; font-size:0px; border:0px; width: 20%;" src="{{ $message->embed(asset('/assets/images/dalda_logo.png')) }}" alt="img" width="100%" height="auto" />
                                            </td>
                                        </tr>
                                        <!--end image-->
                                        <tr>
