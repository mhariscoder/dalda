        ...
        <form id="claimForm" class="needs-validation" novalidate>
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    <label for="fullname">Your ID <span
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control rounded allowNumberOnly"
                           ...
                           value="{{ old('whatsapp_number') }}" minlength="13" maxlength="13" >
                </div>
            </div>
            ...
            <button class="btn btn-primary float-right" type="button"  onclick="submitFormData()">Save</button>
        </form>
                                        ...
                                        <form id="claimForm">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control rounded allowAlphabetOnly"
                                                           id="board_intermediate" name="board_intermediate"
                                                           placeholder="Enter Board in Intermediate"
                                                           value="{{ old('board_intermediate') }}" maxlength="55">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="marks_in_matric">Marks in XI ( Write in this format:
                                                        440/550 ) <span
                                                                class="required-class">*</span></label>
                                                    <input type="text"
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="marks_in">Marks in XII ( Write in this
                                                        format: 800/1100 ) </label>
                                                    <input type="text"
                                                           class="form-control rounded allowSlash marksFormat"
                                                           id="marks_in_xii"
                                            ...
                                            @for($i = 1; $i <= 7; $i++)
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label for="year_of_receiving{{$i}}">Year Of Recieving<span
                                                                    class="required-class">*</span></label>
                                                        <input type="text" class="form-control rounded"
                                                               id="year_of_receiving{{$i}}"
                                                               name="year_of_receiving[{{$i}}]"
...
@push('scripts')
    ...
    <script>
        ...
        function submitFormData() {
            ...
            axios({
                method: 'post',
                url: '/student/add-claim-for-scholarship',
                data: bodyFormData,
                ...
                .then(function (response) {
                    if (response) {
                        ...
                        swal({
                            ...
                            if (successBtn) {
                                window.location.href = "/student/claim-for-scholarship";
                            }
                        }).catch(error => {
                            swal({
