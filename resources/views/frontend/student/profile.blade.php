...
@section('content')
            ...
            <div class="page-title-actions">
                <div class="d-inline-block dropdown">
                    @if (!empty($profile->student_id))
                                <h6 class="mt-2">Student ID#
                                    <span><strong>{{$profile->student_id}}</strong></span>
                                </h6>
                            @endif
                </div>
            </div>
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            ...
            <form action="/student/manage-profile" autocomplete="off" method="POST" class="needs-validation"
                ...
                <div class="form-row">
                    <div class="col-md-12  mb-3">
                        ...
                        <textarea name="profile_detail" class="form-control" rows="3" required>{{ old('profile_detail', $profile->profile_detail) }}</textarea>
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control rounded" id="first_name" name="first_name"
                            placeholder="Enter First Name" value="{{ old('first_name', $profile->first_name) }}" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control rounded" id="last_name" name="last_name"
                            placeholder="Enter Last Name" value="{{ old('last_name', $profile->last_name) }}" required>
                        <div class="invalid-feedback">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control rounded" id="mother_name"
                               ...
                               value="{{ old('mother_name',$profile->mother_name) }}" required>
                               <div class="invalid-feedback">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="email" name="email" placeholder="Email"
                                aria-describedby="inputGroupPrepend" value="{{ old('email', $profile->email) }}" required readonly>
                            <div class="invalid-feedback">
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control rounded" id="dob" name="dob"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input class="form-check-input" type="radio" name="gender" id="exampleRadios1"
                                    value="female" {{ old('gender', $profile->gender) === 'female' ? 'checked' : '' }}>
                                <label class="form-check-label" for="exampleRadios1">Female</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input class="form-check-input" type="radio" name="gender" id="exampleRadios1"
                                    value="other" {{ old('gender', $profile->gender) === 'other' ? 'checked' : '' }}>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="marital_status"
                                id="marital_status">
                            <option value="single" {{old('marital_status',$profile->marital_status) == 'single' ? 'selected' : ''}}>
                                Single
                            </option>
                            <option value="married" {{old('marital_status',$profile->marital_status) == 'married' ? 'selected' : ''}}>
                                Married
                            </option>
                        </select>
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control rounded"
                               ...
                               value="{{ old('address',$profile->postal_address) }}"
                         required>
                        <div class="invalid-feedback">
                ...
                <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <h4 class="card-title float-left ml-2">Your Profile</h4>
                            @if (!empty($profile->student_id))
                                <h4 class="card-title float-right mx-auto">Student ID#
                        ...
                        <div class="card-body">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <form action="/student/manage-profile" method="POST"
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control rounded allowNumberOnly"
                                                           ...
                                                           value="{{ old('cnic',$profile->cnic) }}" minlength="13"
                                                           maxlength="13">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="contact">Contact</label>
                                                    <input type="text" class="form-control rounded allowNumberOnly"
                                                           ...
                                                           value="{{ old('contact',$profile->contact) }}" minlength="11"
                                                           maxlength="13">
                                                </div>
                                            </div>
                                            <div class="form-row">
