                                    ...
                                    @foreach ($documents as $key => $document)
                                        <tr>
                                            ...
                                            @if (!empty($document->name))
                                                <td>
                                                    <a href="{{ Storage::url('uploads/documents/' . $document->name ?? '') }}"
                                                        class="text-primary" target="_blank"
                                                        data-toggle="tooltip" data-placement="bottom" title=""
                                                        data-original-title="Download"><i class="fas fa-download   ml-2"></i></a>
                                                </td>
                                            @else
                                                <td>-</td>
                                            @endif
                                        ...
                                        @foreach ($documents as $key => $document)
                                            <tr>
                                                ...
                                                @if (!empty($document->name))
                                                    <td>
                                                        <a href="{{Storage::url('uploads/documents/'.$document->name ?? '')}}"
                                                           target="_blank" class="btn btn-dark btn-lg">View File</a>
                                                    </td>
                                                @else
                                                    <td>-</td>
                                                @endif
