@foreach($admin_notifications as $key => $val)
    <li>
        <a class="dropdown-item px-2 py-2 border border-top-0 border-left-0 border-right-0" href="/admin/notification-detail/{{$val->id}}">
            <div class="media">
